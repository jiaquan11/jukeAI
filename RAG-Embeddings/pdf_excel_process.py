...
#图像预处理:缩放、转张量、归一化
detection_transforms = transforms.Compose(
    [
        MaxResize(800),
...
def detect_and_crop_save_table(file_path):
    ...
    # 预处理
    pixel_values = detection_transforms(image).unsqueeze(0)
...
if __name__ == '__main__':
    #pdf2images('llama2_page8.pdf') #将PDF每页转成一个PNG图像
    #show_images('llama2_page8') #显示目录中的所有PNG图像

    #detect_and_crop_save_table("llama2_page8/page_1.png") #识别表格，并将表格部分单独存为图像文件
    #show_images("llama2_page8/table_images") #显示目录中的所有PNG图像
